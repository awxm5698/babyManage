...
db.transaction(function (tx) {
    tx.executeSql('CREATE TABLE IF NOT EXISTS ships(id integer primary key autoincrement,user_id,company_id,company_name,ship_date,product_id,product_name,product_type,unit,weight,total,pay_total,remarks)');
